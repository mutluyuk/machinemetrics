...
```{r hy16, warning=FALSE, message=FALSE}
#Data
...
```{r hy17, warning=FALSE, message=FALSE}
tsd <- EuStockMarkets
...
```{r hy18, warning=FALSE, message=FALSE}
plot(
  data$day_index,
  data$FTSE,
  type = "l",
...
```{r hy21, echo=FALSE, out.width = '130%', out.height='130%'}
